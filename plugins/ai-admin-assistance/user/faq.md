...
If you would like to use the AI Assistant features in the plugin, you will need an OpenAI API key. You’ll need to create a free or paid account with OpenAI and obtain an API key to use this plugin. You can set your model (e.g. GPT-3.5 Turbo, GPT-4o, GPT-4.1, GPT-5 Mini, GPT-5 or GPT-5.1) and control costs through the settings panel.
