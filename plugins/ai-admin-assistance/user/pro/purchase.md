...
Alternatively, you can [visit the plugin website](https://www.wpaiplugins.dev/wordpress-ai-admin-assistance/#prices) and choose the plan you would like.
...
As soon as you complete the purchase, you will have access to the [my account portal](https://www.wpaiplugins.dev/log-in/) on our website where it will display your license key and a link to download the pro version add-on plugin. 
